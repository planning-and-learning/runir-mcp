...
|---|---|---|
| Base sketch policy | [`features.*`](runir.ps.base.features.md), [`rules.*`](runir.ps.base.rules.md), [`actions.*`](runir.ps.base.actions.md), [`atoms.*`](runir.ps.base.atoms.md) | Policy features drive state columns; rules/actions/atoms are referenced from witnesses, witness traces, successor frontiers, and plan traces. `atoms.*` includes static atoms but `[facts]` does not repeat them. |
