...
State annotations and feature vectors for traces, cycles, and successor-frontier targets. Cycle witnesses repeat the first row as the final row to close the cycle.
